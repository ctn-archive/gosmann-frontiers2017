...
class Signal(object):
    ...
    offset : int, optional (Default: 0)
        ...
        initial_value in bytes. This might differ from the offset of the NumPy
        array view provided as initial_value if the base initial_value is a
        NumPy array view already (in that case the signal base offset will 0
        because it starts where the provided Numpy view starts, but that NumPy
        view can have an offset of itself).
    """
